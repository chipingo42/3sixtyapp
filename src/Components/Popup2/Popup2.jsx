...
const Popup2 = ({visible, onClose }) => {
  ...
  return (
    <>
      <div className='absolute top-[170px] right-[94px] shadow-1xl rounded-[7px] bg-white h-[160px] w-[200px]'>
        <div onClick={onClose} className='flex space-x-4 px-[20px] py-[10px] group hover:bg-[#356DFB12] '>
